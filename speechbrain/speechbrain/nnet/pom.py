...
class PolynomialMixer(nn.Module):
    ...
    Reference: https://arxiv.org/abs/2411.12663 TODO link to PoM for speech paper
...
class PoM(nn.Module):
    ...
    Attributes:
        ...
        num_heads (int): The number of heads to compute in parallel. NOTE: for now, only one head is supported.

...
from speechbrain.nnet.pom import PolynomialMixer
...
class ConformerEncoderLayer(nn.Module):
    ...
    degree : int, optional
        polynomial degree for PoM
    expand : int, optional
        expansion factor for PoM
    ...
    def __init__(
        ...
        elif attention_type == "PoM" :
            self.mha_layer = PolynomialMixer(
                d_model,
                degree,
                expand,
                num_heads=nhead,
...
class ConformerEncoder(nn.Module):
    ...
    degree : int, optional 
        degree of the polynomial for PoM
    expand : int, optional
        expansion factor for PoM
